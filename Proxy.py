...
try:
  ...
  # ~~~~ INSERT CODE ~~~~
  # Socket library enables network communication by creating sockets for data exchange
  # enable network communication; AF_INET for IPv4, SOCK_STREAM for TCP
...
try:
  ...
  # ~~~~ INSERT CODE ~~~~
  # Tell the socket to use our host and port number
...
try:
  ...
  # ~~~~ INSERT CODE ~~~~
  # try to Start waiting for someone to connect to our socket
...
while True:
  ...
  try:
    # ~~~~ INSERT CODE ~~~~
    #vAccept a connection from the clients and save it to clientAddr
  ...
  # ~~~~ INSERT CODE ~~~~
  # need to get the message the client sending, http.
